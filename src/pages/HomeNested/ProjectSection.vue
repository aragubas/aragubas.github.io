...
<template>
  <section class="project-section">
    ...
    <article class="project-card">
      ...
      <p><i>(Windows Only)</i> Displays a notification and plays a sound when plugging/unplugging laptop charger
      </p>
    ...
    <article class="project-card">
      ...
      <div class="flex gap-small-m">
        <a href="https://github.com/aragubas/aiajsdkafoefpokwepfdoedpefw" target="_blank"
           class="button">Github</a>
        <a href="https://aragubas.github.io/aiajsdkafoefpokwepfdoedpefw/" target="_blank"
...
.project-card {
  animation: project-card-in 0.7s ease;
  display: flex;
...
.language-label[language="python"] {
